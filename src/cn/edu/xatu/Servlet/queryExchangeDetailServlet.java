...
@WebServlet("/queryExchangeDetailServlet")
public class queryExchangeDetailServlet extends HttpServlet {
   ...
   String number = request.getParameter("number");
		...
		{
			request.getRequestDispatcher("/backend/updateExchange.jsp").forward(request, response);
		}
