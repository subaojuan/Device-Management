...
@WebServlet("/queryComputerDetailServlet")
public class queryComputerDetailServlet extends HttpServlet {
   ...
   String number = request.getParameter("number");
		...
		{
			request.getRequestDispatcher("/backend/updateComputer.jsp").forward(request, response);
		}
