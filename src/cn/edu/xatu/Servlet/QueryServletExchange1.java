...
@WebServlet("/QueryServletExchange1")

public class QueryServletExchange1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  request.getRequestDispatcher("/backend/jiaohuanji1.jsp").forward(request, response);
