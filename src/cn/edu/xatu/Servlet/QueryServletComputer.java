...
@WebServlet("/QueryServletComputer")
public class QueryServletComputer extends HttpServlet {
	...
	//	  response.sendRedirect("/backend/computer.jsp");
	  request.getRequestDispatcher("/backend/computer.jsp").forward(request, response);
